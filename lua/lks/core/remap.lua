...
keymap.set("n", "<leader>p", "<C-a>", { desc = "Increment number" })
keymap.set("n", "<leader>m", "<C-x>", { desc = "Decrement number" })
keymap.set("n", "<leader>:", "A:", { desc = "Put : at the end of current line " })
keymap.set("n", "<leader>;", "A;", { desc = "Put ; at the end of current line " })
